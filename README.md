![App picture](./readme/main_picture.jpg)
...
![Dashboard](./readme/dasboard_2.jpg)
...
![Add patient page](./readme/add_new_patient.jpg)

### Patient page

Double click on a patient name on the dashboard to get here.
![Patient page](./readme/patient_page.jpg)
...
![System Settings](./readme/system_settings.jpg)
...
### Backend
![Nodejs - ExpressJS](./readme/backend.jpg)

### Frontend
![jQuery](./readme/frontend.jpg)

### Database
![MongoDB - Mongoose](./readme/database.jpg)

### Databse Schema
![Database schema](./readme/database_design.jpg)
